		...
		<S.SigninWrapper>
			...
			<S.SigninForm onSubmit={handleEmailSignin}>
				<S.InputGroup>
					...
					<S.Input type="email" id="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="Enter your email" required />
				</S.InputGroup>
			...
			<S.GoogleButton onClick={handleGoogleSignin} type="button">
				<S.GoogleIcon>
